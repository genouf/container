...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/02 10:05:16 by genouf            #+#    #+#             */
/*   Updated: 2023/02/02 10:05:17 by genouf           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class set
	{
		public:
			...
			typedef typename ft::RBTreeSet<value_type, key_compare, allocator_type>::const_iterator			iterator;
