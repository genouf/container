...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/02 10:05:28 by genouf            #+#    #+#             */
/*   Updated: 2023/02/02 10:34:08 by genouf           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void display(ft::vector<T, Allocator>& vect) {
...
int	main(void)
{
	// VECTOR
	{
		...
		{
			ft::vector<int> first; 			
			ft::vector<int> second;								// empty vector of ints
	...
	// SET
	{
		...
		std::cout << std::endl << "====== CONSTRUCTOR RANGE =======" << std::endl;
		ft::set<std::string> set_range(st.begin(), st.end());
		std::cout << "====== NEW SET_RANGE IS ======" << std::endl;
		for (ft::set<std::string>::iterator it = set_range.begin(); it != set_range.end(); ++it)
			std::cout << *it << std::endl;
		set_range.insert("allez");
		std::cout << "====== NEW KEY INSERTED TO NEW SET_RANGE ======" << std::endl;
		ft::set<std::string> set_cp(set_range);
		std::cout << "====== NEW SET_CP FROM SET_RANGE IS ======" << std::endl;
		for (ft::set<std::string>::iterator it = set_cp.begin(); it != set_cp.end(); ++it)
			std::cout << *it << std::endl;
		std::cout << std::endl << "====== COPY CONSTRUCTOR =======" << std::endl;
		set_cp.erase("allez");
		...
		std::cout << std::endl << "====== INSERT ======" << std::endl;
		ft::pair<ft::set<std::string>::iterator, bool > pair_return;
